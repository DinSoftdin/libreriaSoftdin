...
class EnumVariablesSistema
{
    ...
    /**
     * Busca elementos por descripción y retorna una colección de claves => id.
     *
     * @param string $description Descripción a buscar.
     * @return \Illuminate\Support\Collection Colección con clave => id de los elementos encontrados.
     */
